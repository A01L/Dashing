...
<!-- 	<li class="nav-category">Инструменты</li>
		...
		<div class="main-content d-flex flex-column flex-md-row">
            ...
            // sql query 
            $sql = "SELECT * FROM `notes` WHERE `mod` = 0 ORDER BY `id` DESC";
            if($result = $conn->query($sql)){
                ...
                foreach($result as $row){
                   ...
                   ?>
                   						...
                   						<div class="dropdown-menu dropdown-menu-right"><a href="../../../vendor/system.php?mod=uarhnote&id=<?php echo $row['id']; ?>">Разархивировать</a>
                   						<a href="../../../vendor/system.php?mod=delnote&id=<?php echo $row['id']; ?>">Удалить</a>
                   					</div></div></div>
                   						<div class="contact-body">
                   							
                   							<textarea readonly id="exampleTextarea1" class="theme-input-style" placeholder="Введите текст..." style="border-radius: 20px;" name="data"><?php echo $row['data']; ?></textarea>
