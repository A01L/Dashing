            ...
            if($result = $conn->query($sql)){
                ...
                foreach($result as $row){
                   ...
                   ?>
                   						...
                   						<div class="contact-box mb-30"><div class="contact-head"><div class="d-flex align-items-center"><div class="avatar img-50 mr-2" style="background-color: <?php echo $row['color']; ?>;"></div><div class="content pl-1"><h4 class="c2 mb-1"><?php echo $row['title']; ?></h4><p><?php echo $row['category']; ?></p></div></div><div class="dropdown-button"><a href="#" class="d-flex align-items-center" data-toggle="dropdown"><div class="menu-icon style--two mr-0"><span></span> <span></span> <span></span></div></a><div class="dropdown-menu dropdown-menu-right"><a href="../../../vendor/system.php?mod=delcont&id=<?php echo $row['id']; ?>">Удалить</a></div></div></div><div class="contact-body"><a href="mailto:<?php echo $row['email']; ?>"><?php echo $row['email']; ?></a> <a href="tel:+026544464698">+<?php echo $row['number']; ?></a></div></div></div><div class="col-xl-2 col-md-4 col-sm-6">
