...
@media (max-width: 991.98px) {
  ...
  followCursor() // вызываем функцию followCursor
		...
		<li>
			<a href="pages/apps/contact/plist_a.php">
...
<!-- 					pages/apps/todolist/add-new.html
 -->				</li>
	...
	<li class="nav-category">Инструменты</li>
			...
			<li>
				<a href="pages/ecommerce/filt.php">
 ...
 -->
			...
			?>₸
				...
				$pb = get_data_db($connect, "base", "deposit", "id", 2);
				$full = 100000;
			...
			<p class="font-14 mt-10 c4 mb-30">*Ваша цель 1,000,000₸</p>

			<!-- <a href="#" class="btn mb-10">Инкассация</a> -->
		</div>
	</div>
</div>
			...
			<div class="d-flex position-relative">
				...
				<div class="todo-text">
					...
					<?php 
					 ...
					 ?>
					<p class="font-12 mb-0" style="<?php echo $sty; ?>"><?php echo $comment['title']; ?> | <?php echo $comment['date']; ?> | <?php echo get_data_db($connect, "personals", "email", "id", $comment['personal']); ?></p>
				</div>
			</div>
			<div class="d-flex">
...
<div><p style="font-size: 1.2em;" id="imgLoad">загрузка...</p></div>
	...
	<div class="col-xl-6 col-lg-12"><div class="row">
