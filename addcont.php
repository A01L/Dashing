 ...
 -->
					...
					<div class="main-content">
						...
						<div class="form-element base-control mb-30" style="width: 48%; float: left;">
							<h4 class="font-20 mb-4">Добавить новый контакт</h4>

							<form action="vendor/system.php" method="post">
								<div class="form-group mb-4">
									<label for="addonEmail" class="mb-2 font-14 bold">Заголовок номера</label>
								...
								<div class="form-group mb-4">
									<label for="addonEmail" class="mb-2 font-14 bold">Категория номера</label>
									<div class="input-group addon">
										<div class="input-group-prepend">
											<div class="input-group-text bold">#</div>
										</div>
										<input type="text" id="addonEmail" name="cat" class="form-control" placeholder="Сотрудник, компания, Тех. Поддержка...">
									</div>
								</div>
							<div class="form-group mb-4">
									<label for="addonEmail" class="mb-2 font-14 bold">Email</label>
									<div class="input-group addon">
										<div class="input-group-prepend">
											<div class="input-group-text bold">Email</div>
										</div>
										<input type="text" id="addonEmail" name="email" class="form-control" placeholder="example@email.com">
									</div>
								</div>

							<div class="form-group mb-4">
									<label for="addonEmail" class="mb-2 font-14 bold">Номер телефона</label>
									<div class="input-group addon">
										<div class="input-group-prepend">
											<div class="input-group-text bold">+</div>
										</div>
										<input type="text" id="addonEmail" name="num" class="form-control" placeholder="7*** *** ** **, 1*** *** ** **">
									</div>
								</div>
								<div class="form-group mb-4">
									<label for="addonEmail" class="mb-2 font-14 bold">Цветная отметка</label>
									<div class="input-group addon">
										<div class="input-group-prepend">
											<div class="input-group-text bold">!</div>
										</div>
										<input type="color" id="addonEmail" name="color" class="form-control" placeholder="...">
									</div>
								</div>
								<input type="text" name="mod" readonly hidden value="addcontact">
							<div class="button-group pt-1">
								<button class="btn long">Добавить контакт</button>
